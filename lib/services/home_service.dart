...
class HomeService {
  ...
  // ✅ FIX: Call this on app startup to restore token from storage
  ...
  // ✅ FIX: Correct block endpoint matching React Native
  ...
  // ✅ FIX: Multipart upload for profile media (step 2)
  // Field names must match React Native exactly: profile_picture, video, image1..image6
...
//     return await _api.fetch(
//       Api(url: "user/user-profile-match.php?page=$page&per_page=20", method: "POST"),
//       {}, // Empty parameters if none required besides URL query
//     );
//   }
//   Future<Map<String, dynamic>> getMatchProfilesWithFilter(Map<String, dynamic> body) async {
//     return await _api.fetch(
//       Api(url: "user/user-profile-match.php?page=1&per_page=20", method: "POST"),
//       body,
//     );
...
//   }
//   Future<bool> toggleFavorite(int id, bool currentlyFav) async {
//     final endpoint = currentlyFav ? 'user/user-unfavourite.php' : 'user/user-add-favourite.php';
//
//     final res = await _api.fetch(
//       Api(url: endpoint, method: "POST"),
//       {"profile_user_id": id},
...
//
//   Future<bool> toggleInterest(int id, bool currentlyInterested) async {
//     final endpoint = currentlyInterested ? '/user/user-uninterest.php' : '/user/user-add-interest.php';
//
//     final res = await _api.fetch(
//       Api(url: endpoint, method: "POST"),
//       {"profile_user_id": id},
...
//     return await _api.fetch(
//       method: "POST",
//       url: "user/user-profile-match.php?page=$page&per_page=20",
//     );
//   }
//
//   Future<bool> toggleFavorite(int id, bool currentlyFav) async {
//     final url = currentlyFav ? 'user/user-unfavourite.php' : 'user/user-add-favourite.php';
//     final res = await _api.fetch(method: "POST", url: url, body: {"profile_user_id": id});
//     return res['success'] == true;
//   }
//
//   Future<bool> toggleInterest(int id, bool currentlyInterested) async {
//     final url = currentlyInterested ? '/user/user-uninterest.php' : '/user/user-add-interest.php';
//     final res = await _api.fetch(method: "POST", url: url, body: {"profile_user_id": id});
//     return res['success'] == true;
//   }
// }