...
import 'package:two_are_one/ui/views/auth/email_otp_verification.dart';
 ...
 void _handleSignUp() async {
  ...
  try {
   ...
   if (result['success']) {
    ...
    //    children: [
    //      Images(imageStr: "assets/svg_images/error.svg"),
    //     const Texts(
    //         text: "Oops, Failed!", colorHexValue: 0xFFdf605f,
    //         size: 22, fontWeight: FontWeight.bold),
    //
    //    ],
    //  ),
    //  content: Texts(text: 'Email Already Exists',
