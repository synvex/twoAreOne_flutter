...
import '../services/Api_Helper/api_manager.dart' show navigatorKey;
...
class BlockedUserViewModel extends ChangeNotifier {
  ...
  Future<bool> unblockUser(VisitedBlockedUserModel user) async {
    ...
    if (res['success'] == true) {
      ...
      // Keep the Home banner's BLOCKS count in sync immediately.
      navigatorKey.currentContext?.read<UserStatsViewModel>().userUnblocked();
      notifyListeners();
      return true;
    }
    notifyListeners();
