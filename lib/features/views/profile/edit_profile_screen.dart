...
class _EditProfileScreenState extends State<EditProfileScreen>
  ...
  Future<bool> _requestGalleryPermission() async {
    ...
    // Android 13+ (API 33+) needs READ_MEDIA_IMAGES/READ_MEDIA_VIDEO, which
    // permission_handler exposes as Permission.photos. Below API 33, the
    // classic Permission.storage is what's needed. Requesting storage-only
    // (the old code) silently fails on API 33+ devices — that was the bug.
