...
class LocationSelectorField extends StatefulWidget {
  ...
  /// NEW: fired whenever a previously-valid selection becomes stale
  /// (user edits the text, or clears the field) so the parent can
  /// drop its cached LocationData instead of silently keeping it.
...
class _LocationSelectorFieldState extends State<LocationSelectorField> {
  ...
  // Inline error shown under the field, same pattern as other fields.
  String? _locationError;

  // Tracks whether the text currently in the field matches a confirmed,
  // state-bearing selection. Any manual edit invalidates this.
  ...
  Future<void> _onSearchChanged(String query) async {
    // Any manual edit invalidates a previously confirmed selection.
