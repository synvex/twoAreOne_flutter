...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _getUserInfo() async {
    ...
    if (res['success'] == true && res['data'] is Map) {
      setState(() {
        _profile = UserFullProfile.fromJson(
      ...
      children: [
        Row(
          children: [
            ...
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [bar(120, 18), const SizedBox(height: 8), bar(160, 14)],
            ),
          ],
        ),
        const Spacer(),
                  ...
                  child: _imageLoader
                      ...
                      : ClipOval(
                          child: avatarUrl.isNotEmpty
                              ...
                              : ColoredBox(
                                  color: Colors.blueGrey.shade300.withValues(
                                    alpha: .4,
                                  ),
                                ),
                        ),
        ...
        return Padding(
          ...
          child: GestureDetector(
            ...
            child: AnimatedOpacity(
              ...
              opacity: isPressed
                  ? 0.6
                  : 1.0, // React Native ki tarah content light ho jayega
              child: Container(
                ...
                child: Row(
                  children: [
                    ...
                    Images(
                      imageStr: "assets/svg_images/Profile/chevron-right.svg",
                      height: 20,
                      color: Colors.black.withValues(alpha: 0.8),
                    ),
                  ],
